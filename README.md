...
serious way. <span class=GramE>![</span>Status](https://img.shields.io/badge/status-active%20development-blue<span
class=GramE>) !</span>[Python](https://img.shields.io/badge/python-3.13+-blue<span
